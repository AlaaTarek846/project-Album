...
<!-- Mirrored from skote-v-rtl.codeigniter.themesbrand.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Jul 2022 21:07:18 GMT -->
<!-- Added by HTTrack -->
...
{{--                                    <div class="col-sm-5">--}}
{{--                                        <div>--}}
{{--                                            <img src="{{asset('dashboard/assets/images/megamenu-img.png')}}" alt=""--}}
...
{{--                        <img src="{{asset('dashboard/assets/images/flags/us.jpg')}}" alt="Header Language" height="16"></button>--}}
...
{{--                           data-lang="en">--}}
{{--                            <img src="{{asset('dashboard/assets/images/flags/us.jpg')}}" alt="user-image" class="me-1" height="12"> <span--}}
{{--                                class="align-middle">English</span>--}}
{{--                        </a>--}}

{{--                        <a href="http://localhost:8080/lang/es" class="dropdown-item notify-item language"--}}
{{--                           data-lang="sp">--}}
{{--                            <img src="{{asset('dashboard/assets/images/flags/spain.jpg')}}" alt="user-image" class="me-1" height="12"> <span--}}
{{--                                class="align-middle">Spanish</span>--}}
{{--                        </a>--}}

{{--                        <a href="http://localhost:8080/lang/de" class="dropdown-item notify-item language"--}}
{{--                           data-lang="gr">--}}
{{--                            <img src="{{asset('dashboard/assets/images/flags/germany.jpg')}}" alt="user-image" class="me-1" height="12"> <span--}}
{{--                                class="align-middle">German</span>--}}
{{--                        </a>--}}

{{--                        <a href="http://localhost:8080/lang/it" class="dropdown-item notify-item language"--}}
{{--                           data-lang="it">--}}
{{--                            <img src="{{asset('dashboard/assets/images/flags/italy.jpg')}}" alt="user-image" class="me-1" height="12"> <span--}}
{{--                                class="align-middle">Italian</span>--}}
{{--                        </a>--}}

{{--                        <a href="http://localhost:8080/lang/ru" class="dropdown-item notify-item language"--}}
{{--                           data-lang="ru">--}}
{{--                            <img src="{{asset('dashboard/assets/images/flags/russia.jpg')}}" alt="user-image" class="me-1" height="12"> <span--}}
...
{{--                            <a href="#" class="text-reset notification-item">--}}
{{--                                <div class="d-flex">--}}
{{--                                    <img src="{{asset('dashboard/assets/images/users/avatar-3.jpg')}}" class="me-3 rounded-circle avatar-xs"--}}
{{--                                         alt="user-pic">--}}
{{--                                    <div class="flex-grow-1">--}}
...
{{--                            <a href="#" class="text-reset notification-item">--}}
{{--                                <div class="d-flex">--}}
{{--                                    <img src="{{asset('dashboard/assets/images/users/avatar-4.jpg')}}" class="me-3 rounded-circle avatar-xs"--}}
{{--                                         alt="user-pic">--}}
{{--                                    <div class="flex-grow-1">--}}
...
{{--                                class="bx bx-lock-open font-size-16 align-middle me-1"></i> <span key="t-lock-screen">Lock screen</span></a>--}}
...
{{--                                    <th scope="row">--}}
{{--                                        <div>--}}
{{--                                            <img src="{{asset('dashboard/assets/images/product/img-4.png')}}" alt="" class="avatar-sm">--}}
{{--                                        </div>--}}
{{--                                    </th>--}}
{{--                                    <td>--}}
{{--                                        <div>--}}
...
{{--                       data-bsStyle="{{asset('dashboard/assets/css/bootstrap-dark.min.css')}}" data-appStyle="assets/css/app-dark.min.css">--}}
...
<!-- Mirrored from skote-v-rtl.codeigniter.themesbrand.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Jul 2022 21:09:15 GMT -->
</html>
